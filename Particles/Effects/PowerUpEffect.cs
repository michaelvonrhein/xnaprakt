...
{
    class PowerUpEffect : ManagedEffect
    {
        ...
        public override void Update(BaseMeshPart mesh)
        {
            ...
            fTime += (float)World.Instance.GameTime.ElapsedGameTime.Milliseconds / 5000f;// 10000f;
