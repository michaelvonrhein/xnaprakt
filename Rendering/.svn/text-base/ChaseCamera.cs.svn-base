...
namespace PraktWS0708.Rendering
{
    public class ChaseCamera
    {
        ...
        private float stiffness = 8000.0f;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            // Prevent overshooting for low framerates and high velocitites
            if ((position - desiredPosition).LengthSquared() <= (velocity * elapsed).LengthSquared())
            {
                position = desiredPosition;
            }
            else
